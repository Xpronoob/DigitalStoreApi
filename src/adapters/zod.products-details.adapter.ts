...
export class ZodProductDetailsAdapter {
  ...
  static validateProductDetail = (productDetail: ProductDetailEntity) => {
    ...
    const ProductDetail = z.object({
      ...
      }).min(1, "El nombre del detalle debe tener al menos 1 carácter").max(255, "El nombre del detalle no puede tener más de 255 caracteres"),
  ...
  static validateProductDetailUpdate = (productDetail: ProductDetailEntityOptional) => {
    ...
    const ProductDetail = z.object({
      detail_name: z.string().min(1, "El nombre del detalle debe tener al menos 1 carácter").max(255, "El nombre del detalle no puede tener más de 255 caracteres").optional(),
