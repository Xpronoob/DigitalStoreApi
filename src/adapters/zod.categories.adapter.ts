...
export class ZodCategoriesAdapter {
  ...
  static validateCategory = (category: CategoryEntity) => {
    ...
    const Category = z.object({
      ...
      }).min(1, "El nombre de la categoría debe tener al menos 1 carácter").max(255, "El nombre de la categoría no puede tener más de 255 caracteres"),
      active: z.boolean(),
  ...
  static validateCategoryUpdate = (category: CategoryEntityOptional) => {
    ...
    const Category = z.object({
      category_name: z.string().min(1, "El nombre de la categoría debe tener al menos 1 carácter").max(255, "El nombre de la categoría no puede tener más de 255 caracteres").optional(),
